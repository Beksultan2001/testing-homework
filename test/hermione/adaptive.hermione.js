...
describe('Вёрстка должна адаптироваться под ширину экрана в странице Home', async function() {
...
describe('Вёрстка должна адаптироваться под ширину экрана в странице Catalog', async function() {
    it('Верстка главноый страницы должна быть корректной при ширине экрана 1920px', async function({browser}) {
...
describe('Вёрстка должна адаптироваться под ширину экрана в странице Delivery', async function() {
    it('Верстка главноый страницы должна быть корректной при ширине экрана 1920px', async function({browser}) {
...
describe('Вёрстка должна адаптироваться под ширину экрана в странице Contacts', async function() {
    it('Верстка главноый страницы должна быть корректной при ширине экрана 1920px', async function({browser}) {
...
describe('Вёрстка должна адаптироваться под ширину экрана в странице Cart', async function() {
    it('Верстка главноый страницы должна быть корректной при ширине экрана 1920px', async function({browser}) {
